...
/world/Reboot(var/reason, var/feedback_c, var/feedback_r, var/time)
	...
	spawn(0)
		to_chat(world, sound(pick('sound/misc/cantbelieve.ogg','sound/AI/newroundsexy.ogg','sound/misc/damnfiddle.ogg','sound/misc/wakemeup.ogg','sound/misc/oooaiao.ogg')))// random end sounds!! - LastyBatsy
